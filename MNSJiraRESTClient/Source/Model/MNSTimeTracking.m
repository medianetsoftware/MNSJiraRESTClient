...
@implementation MNSTimeTracking
...
- (id)initWithOriginalEstimateMinutes:(NSInteger)originalEstimateMinutes remainingEstimateMinutes:(NSInteger)remainingEstimateMinutes timeSpentMinutes:(NSInteger)timeSpentMinutes {
	self = [super init];
	if (self) {
		_originalEstimateMinutes = originalEstimateMinutes;
		_remainingEstimateMinutes = remainingEstimateMinutes;
		_timeSpentMinutes = timeSpentMinutes;
	}
	return self;
}
