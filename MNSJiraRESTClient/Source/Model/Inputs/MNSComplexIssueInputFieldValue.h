//
//  MNSComplexIssueInputFieldValue.h
//
...
@interface MNSComplexIssueInputFieldValue : NSObject

@property (nonatomic, copy) NSObject *values;
...
- (NSDictionary *)generateJSONVersion;
